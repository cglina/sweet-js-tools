...
import { sweetTypeCheck } from "../basicTypes.js";
/**
 ...
 * arrayFromNr(NaN) → []
 */
export function arrayFromNr(nr = 10, base = 1) {
 ...
 * zeroToNumber(NaN) → []
 */
export function zeroToNumber(nr = 10) {
    if (!Number.isFinite(nr) || nr === 0)
        return [];
    if (nr > 0)
        return arrayFromNr(nr, 0);
 ...
 */
export function propMapCull(array = [], prop = 'length') {
 ...
 */
export function propMap(array = [], prop = 'length', elseVal = false) {
 ...
 */
export function sortNumbers(numArray) {
 ...
 * arrayParts([1, 2], 0) → []
 */
export function arrayParts(array, partLength = 2) {
    if (partLength <= 0)
        return [];
 ...
 */
export function paginationSlices(array, partLength = 3) {
 ...
 */
export function includeType(arr = [], typeFilter = 'string') {
    if (arr.length === 0)
        return [];
 ...
 */
export function excludeType(arr = [], typeFilter = 'string') {
    if (arr.length === 0)
        return [];
    return arr.filter(item => !sweetTypeCheck(item, typeFilter));
}
 ...
 */
export function typeOrDefault(arr = [], typeFilter = 'string', falseDefault = false) {
    if (arr.length === 0)
        return [];
 ...
 */
export function typeMatchMap(arr = [], typeFilter = 'string') {
    if (arr.length === 0)
        return [];
