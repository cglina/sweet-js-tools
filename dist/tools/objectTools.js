 ...
 * // {}
 */
export function objEntryTypes(obj, returnType = 'object') {
    // checks if obj isn't empty
    if (!isObjectX(obj)) {
        return returnType === 'array' ? [] : {};
    }
    const map = Object.keys(obj).map(key => [key, typeof obj[key]]);
    if (returnType === 'array') {
        return map;
    }
 ...
 */
export function fixEmptyVals(obj, mode = "remove") {
    if (!isObjectX(obj))
        return {};
    const result = {};
 ...
 * // [[]]
 */
export function cleanEntries(obj) {
    if (isNullish(obj))
        return [[]];
 ...
 */
export function fixEmptyX(obj, mode = "remove") {
    if (!isObjectX(obj))
        return {};
    const result = {};
    Object.entries(obj).forEach(([key, value]) => {
 ...
 * // []
 */
export function clearObjEntries(obj) {
    if (!isObjectX(obj))
        return [];
 ...
 * // []
 */
export function clearObjKeys(obj) {
    if (!isObjectX(obj))
        return [];
    const clearObj = fixEmptyX(obj, 'remove');
 ...
 * // []
 */
export function clearObjValues(obj) {
    if (!isObjectX(obj))
        return [];
    const clearObj = fixEmptyX(obj, 'remove');
 ...
 * // { user_firstName: "Lina" }
 */
export function objModKeys(obj, modMethod = (key) => key) {
    if (isNullish(obj))
        return {};
 ...
 * // { name: "Lina", age: 32 }
 */
export function objModVals(obj, modMethod = (_key, value) => value) {
    if (isNullish(obj))
        return {};
    const result = Object.entries(obj).map(([key, value]) => {
        try {
 ...
 * // }
 */
export function objPick(obj, keys, fallback) {
    if (isNullish(obj))
        return {};
    const result = {};
    keys.forEach(key => {
